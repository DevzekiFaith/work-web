  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <p className="text-center text-gray-600 mb-10">
        We are always looking for passionate and talented individuals to help shape the future of design, construction, and technology.
      </p>
      <div className="space-y-8">
        <div className="border rounded p-6 shadow hover:shadow-md transition">
          ...
          <p className="text-gray-600 mb-4">We are looking for creative architects with experience in modern sustainable design and planning.</p>
        ...
        <div className="border rounded p-6 shadow hover:shadow-md transition">
          ...
          <p className="text-gray-600 mb-4">Experienced in handling large-scale projects? We would love to have you on board.</p>
